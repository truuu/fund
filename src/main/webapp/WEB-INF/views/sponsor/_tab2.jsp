...
<ul class="nav nav-tabs">
  ...
  <c:if test="${ sponsor.id != 0 }">
    ...
    <li class="${ tab5 }"><a href="${R}sponsor/files.do?id=${sponsor.id}&${pagination.queryString}">첨부파일(${fileCount})</a></li>
    <li class="${ tab6 }"><a href="${R}sponsor/log/list.do?id=${sponsor.id}&${pagination.queryString}">변경이력</a></li>
    <li class="${ tab7 }"><a href="${R}sponsor/event/list.do?sid=${sponsor.id}&${pagination.queryString}">예우관리</a></li>
  </c:if>
</ul>