...
<table class="table table-bordered lbw150">
  <tr>
    ...
    <td>
        ...
        <a href="#churchDialog" class="btn btn-sm btn-gray" data-toggle="modal" tabindex="2">검색</a>
    </td>
  </tr>
  <tr>
    <td class="lb">이름</td>
  ...
  <tr>
    ...
    <td rowspan="2">
      ...
      <input type="button" onclick="postCodeSearch('officePostCode', 'officeRoadAddress')" value="우편번호 찾기" class="btn btn-sm"  tabindex="2" /> <br/>
  ...
  <tr>
    <td class="lb">이메일</td>
    <td><input  type="email" name="email" placeholder="abcd@skhu.kr" value="${ sponsor.email}" tabindex="1" /> </td>
    <td></td>
    <td></td>
  </tr>
  <tr>
